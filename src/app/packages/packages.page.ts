...
export class PackagesPage {
  ...
  constructor(public navCtrl: NavController, private http:HttpClient, private toastCtrl: ToastController,
    private platform: Platform, private loadingCtrl: LoadingController, private router: Router, private activateRoute: ActivatedRoute) {
        ...
        .subscribe(data => {
          loading.then((loadingData) => { loadingData.dismiss(); });
            ...
            if (this.resultObj.code == 200) {
                ...
                this.capPerDay=this.resultObj.cap_perday;
            }
        },
  ...
  //         if (this.resultObj.code == 200) {
  //           this.toastCtrl.create({
  //             message: 'Subscribed successfully.', position: 'top', duration: 2700, cssClass: "custom-success-class"
  //           }).then((toastData) => { toastData.present(); });
